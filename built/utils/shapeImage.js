...
function shapeImage(buffer, tileDimensionsPixels) {
    return __awaiter(this, void 0, void 0, function () {
        var imageFile, clonedImage, x, y, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, Jimp.read(buffer)];
                case 1:
                    imageFile = _a.sent();
                    clonedImage = imageFile.clone();
                    if (clonedImage.bitmap.width > clonedImage.bitmap.height) {
                        x = Math.floor((clonedImage.bitmap.width - clonedImage.bitmap.height) / 2);
                        ...
                        y = Math.floor((clonedImage.bitmap.height - clonedImage.bitmap.width) / 2);
