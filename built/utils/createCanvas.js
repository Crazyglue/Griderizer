...
function createCanvas(columns, rows, cellWidth, cellHeight, images) {
    return __awaiter(this, void 0, void 0, function () {
        var canvasPromise, canvas, totalImageCount, index, _a, count, image, j, _b, width, height, canvasY, canvasX, y, x, color;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    canvasPromise = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
